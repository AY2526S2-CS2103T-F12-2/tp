...
1. Open a command terminal, `cd` into the folder you put the jar file in, and use the `java -jar \[CS2103T-F12-2\]\[CampusLink\].jar` command to run the application.<br>
